...
export default function DomainsTab() {
  ...
  const handleSaveWebhook = async () => {
    ...
    try {
      ...
      const errorObj = error as { message?: string };
      alert(errorObj.message || "Failed to save webhook configuration");
    } finally {
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {domain.status === "verified" && (
                        <>
                          <button
                            onClick={() => handleOpenWebhookModal(domain)}
                            className="text-indigo-600 hover:text-indigo-900 text-sm font-medium"
                          >
                            {domain.webhook_url ? "Edit Webhook" : "Add Webhook"}
                          </button>
      ...
      {showWebhookModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-lg shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                Webhook for {showWebhookModal.domain}
              </h3>
              <p className="text-sm text-gray-600 mb-4">
                FreeResend will POST delivery events to this URL signed with the secret.
                Set the same secret as <code className="bg-gray-100 px-1 rounded">RESEND_WEBHOOK_SECRET</code> in your app instance.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="https://yourdomain.com/api/webhooks/resend"
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm font-mono text-xs"
                    />
                    <button
                      onClick={handleGenerateWebhookSecret}
                      className="flex-shrink-0 px-3 py-2 text-sm font-medium text-white bg-gray-600 hover:bg-gray-700 rounded-md"
                    >
                      Generate
                    </button>
                  </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={savingWebhook || !webhookUrl.trim() || !webhookSecret.trim()}
